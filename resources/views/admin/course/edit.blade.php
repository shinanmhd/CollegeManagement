...
@section('content')
    <div class="flex flex-col">
        ...
        {{--form--}}
        <form action="{{ route('admin.course.update', ['course' => $course]) }}" method="post" class="flex flex-col space-y-8 p-12 m-6 w-3/4 border rounded-lg mt-12">
            @csrf
            {{ method_field('PATCH') }}
            ...
            <div class="flex space-x-8">
                <div class="flex flex-col w-full">
                    ...
                    <input type="text" name="name" id="name" class="input-text" value="{{ $course->name }}">
                </div>
            </div>
            ...
            <div class="flex space-x-8">
                <div class="flex flex-col w-full">
                    ...
                    <textarea name="description" id="description" rows="2" class="input-text w-full">{{ $course->description }}</textarea>
                </div>
            </div>
            ...
            <div class="flex space-x-8">
                <div class="flex flex-col w-1/2">
                    ...
                    <input type="text" name="school_year" id="school_year" class="input-text" value="{{ $course->school_year }}">

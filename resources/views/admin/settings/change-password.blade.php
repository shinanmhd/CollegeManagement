...
@section('content')
    <div class="grid grid-cols-12 min-h-screen">
        <div class="col-span-2 h-full border-r">
            @include('admin.settings.settings-nav', ['active' => 'change-password'])
        </div>
        ...
        <div class="col-span-10 flex flex-col">
            ...
            <form action="{{ route('admin.update-password') }}" method="post" enctype="multipart/form-data" class="w-7/12 flex flex-col p-6 pt-0 space-y-8">
                @csrf

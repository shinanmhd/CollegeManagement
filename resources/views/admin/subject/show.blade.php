...
@section('content')
    <div class="flex flex-col">
        ...
        <div class="flex items-center justify-between bg-gray-50 border-b border-gray-100 p-4">
            <h1 class="text-3xl font-semibold">Course subjects for: {{ $course->name }}</h1>

            <div class="flex items-center space-x-2">
                <a href="{{ route('admin.course.index') }}" class="px-4 py-2 rounded-lg text-gray-500 hover:text-gray-800 hover:bg-gray-200 hover:shadow-xl flex items-center space-x-2 transition-all">
                ...
                <a href="{{ route('admin.subject.create', ['cid' => $course->id]) }}" class="px-4 py-2 rounded-lg bg-green-100 text-green-900 hover:bg-green-500 hover:shadow-xl hover:text-white flex items-center space-x-2 transition-all">
        ...
        <div class="my-6 p-4">
            <div class="grid grid-cols-12">
                ...
                <div class="col-span-9 font-medium bg-gray-900 text-white p-2">Subject Name</div>
        ...
        @foreach ($course->subjects as $subject)
            <div class="grid grid-cols-12 border-b border-l border-r hover:bg-gray-50 font-base">
                ...
                <div class="col-span-9 flex items-center p-4">{{ $subject->name }}</div>
                <div class="col-span-2 flex items-center justify-center space-x-2">
                    ...
                    <form method="POST" action="{{ route('admin.student.destroy', [ 'student'=> $subject->id ]) }}" onSubmit="if(!confirm('Are you sure you want to delete this subject?')){return false;}">
                        @csrf

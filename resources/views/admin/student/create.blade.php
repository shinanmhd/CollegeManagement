...
@section('content')
    <div class="flex flex-col p-4">
        ...
        <div class="flex items-center justify-between pb-4 border-b">
            <h1 class="text-3xl font-semibold">Add new Student</h1>
        ...
        {{--form--}}
        <form action="{{ route('admin.student.store') }}" method="post" class="flex flex-col space-y-8 p-12 w-3/4 border rounded-lg mt-12">
            @csrf

...
@section('content')
    <div class="flex flex-col p-4">
        ...
        {{--form--}}
        <form action="{{ route('admin.student.update', ['student' => $user]) }}" method="post" class="flex flex-col space-y-8 p-12 w-3/4 border rounded-lg mt-12">
            @csrf
            {{ method_field('PATCH') }}
            ...
            <div class="flex space-x-8">
                <div class="flex flex-col w-1/2">
                    ...
                    <input type="text" name="first_name" id="first_name" class="input-text" value="{{ $user->student->first_name }}">
                ...
                <div class="flex flex-col w-1/2">
                    ...
                    <input type="text" name="last_name" id="last_name" class="input-text" value="{{ $user->student->last_name }}">
                </div>
            </div>
            ...
            <div class="flex space-x-8">
                ...
                <div class="flex flex-col w-1/4">
                    ...
                    <input type="text" name="email" id="email" class="input-text" value="{{ $user->email }}">
                </div>
                ...
                <div class="flex flex-col w-1/4">
                    ...
                    <input type="text" name="age" id="age" class="input-text w-32" value="{{ $user->student->age }}">
                </div>
                ...
                <div class="flex flex-col w-1/4§    ">
                    ...
                    <div class="flex space-x-10 mt-2">
                        <div class="flex space-x-2">
                            <input type="radio" name="gender" id="male" class="mt-0.5" value="m" {{ $user->student->gender == 'm' ? 'checked' : '' }}>
                            <label for="male" class="input-label">Male</label>
                        </div>

                        <div class="flex space-x-2">
                            <input type="radio" name="gender" id="female" class="mt-0.5" value="f" {{ $user->student->gender == 'f' ? 'checked' : '' }}>
            ...
            <div class="flex space-x-8">
                <div class="flex flex-col w-full">
                    ...
                    <textarea name="contact_address" id="contact_address" rows="2" class="input-text w-full">{{ $user->student->contact_address }}</textarea>
                </div>
            </div>

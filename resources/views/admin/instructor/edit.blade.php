...
@section('content')
    <div class="flex flex-col p-4">
        ...
        <div class="flex items-center justify-between pb-4 border-b">
            <h1 class="text-3xl font-semibold">Edit Instructor</h1>
        ...
        {{--form--}}
        <form action="{{ route('admin.instructor.update', ['instructor' => $instructor]) }}" method="post" class="flex flex-col space-y-8 p-12 w-3/4 border rounded-lg mt-12">
            @csrf
            {{ method_field('PATCH') }}
            ...
            <div class="flex space-x-8">
                <div class="flex flex-col w-1/2">
                    ...
                    <input type="text" name="first_name" id="first_name" class="input-text" value="{{ $instructor->first_name }}">
                ...
                <div class="flex flex-col w-1/2">
                    ...
                    <input type="text" name="last_name" id="last_name" class="input-text" value="{{ $instructor->last_name }}">
                </div>
            </div>
            ...
            <div class="flex space-x-8">
                ...
                <div class="flex flex-col w-1/4">
                    ...
                    <input type="text" name="email" id="email" class="input-text" value="{{ $instructor->user->email }}">
                </div>

                <div class="flex flex-col w-1/4">
                    <label for="age" class="flex justify-between w-32">
                        <span class="input-label">Age</span>
                        @if ($errors->has('age'))
                            <span class="input-error">{{ $errors->first('age') }}</span>
                        @endif
                    </label>
                    <input type="text" name="age" id="age" class="input-text w-32" value="{{ $instructor->age }}">
                </div>
                ...
                <div class="flex flex-col w-1/4§    ">
                    ...
                    <div class="flex space-x-10 mt-2">
                        <div class="flex space-x-2">
                            <input type="radio" name="gender" id="male" class="mt-0.5" value="m" {{ $instructor->gender == 'm' ? 'checked' : '' }}>
                            <label for="male" class="input-label">Male</label>
                        </div>

                        <div class="flex space-x-2">
                            <input type="radio" name="gender" id="female" class="mt-0.5" value="f" {{ $instructor->gender == 'f' ? 'checked' : '' }}>
            ...
            <div class="flex space-x-8">
                <div class="flex flex-col w-full">
                    ...
                    <textarea name="contact_address" id="contact_address" rows="2" class="input-text w-full">{{ $instructor->contact_address }}</textarea>
                </div>
            </div>
            ...
            <div class="flex flex-col">
                ...
                <div class="flex space-x-8 mt-1 italic text-gray-400">
                    <span class="text-sm">Leave passwords blank to keep the old password</span>
                </div>
            </div>

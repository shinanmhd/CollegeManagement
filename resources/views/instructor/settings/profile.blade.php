...
@section('content')
    <div class="container mx-auto">
        <div class="grid grid-cols-12 min-h-screen">
            ...
            <div class="col-span-6 col-start-4 flex flex-col mt-6">

                <h1 class="text-2xl font-bold text-gray-700 p-6 text-center">Edit Profile</h1>

                <form action="{{ route('instructor.update-profile') }}" method="post" enctype="multipart/form-data" class="flex flex-col p-6 pt-0 space-y-8">
                    @csrf
                    {{--image--}}
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="email" name="email" id="email" class="input-text opacity-50" disabled value="{{ old('email', $user->email) }}">
                    </div>
